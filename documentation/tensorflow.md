...
## Benchmarks
This document is an early recipe for building and running TensorFlow with LIBXS. Please do not expect any performance advantage (at this point) when comparing to TensorFlow without LIBXS! Please note that the symbolic link ("models") shown below should **not** be present when configuring TensorFlow!
