...
The interface is available for C. There is a collection of code samples ([samples/deeplearning](https://github.com/hfp/libxs/tree/master/samples/deeplearning)) available including a light-weight [framework for deep learning (GXM)](https://github.com/hfp/libxs/tree/master/samples/deeplearning/gxm), and samples with focus on [Convolutional Deep Neural Networks (DNNs)](https://github.com/hfp/libxs/tree/master/samples/deeplearning/cnnlayer), [LSTM cells](https://github.com/hfp/libxs/tree/master/samples/deeplearning/lstmcell), and an [example](https://github.com/hfp/libxs/tree/master/samples/deeplearning/iconv/README.md#image-convolution) which just convolves a single image. The general concept of the interface is circled around a few types: `libxs_dnn_layer`, `libxs_dnn_buffer`, `libxs_dnn_bias`, and `libxs_dnn_filter`. A handle of such a type is always setup by calling a create-function.
