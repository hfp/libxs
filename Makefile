...
SRCFILES_GEN = $(patsubst %,$(SRCDIR)/%,generator_driver.c generator_common.c generator_dense.c generator_dense_common.c generator_dense_avx.c generator_dense_instructions.c, generator_dense_avx2_microkernel.c, generator_dense_sse_avx_avx2_common.c)
