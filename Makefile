...
OBJFILES_HST = $(BLDDIR)/intel64/libxs.o $(BLDDIR)/intel64/libxs_alloc.o $(BLDDIR)/intel64/libxs_transpose.o \
               $(BLDDIR)/intel64/libxs_gemm.o $(BLDDIR)/intel64/libxs_gemm_wrap.o
OBJFILES_MIC = $(BLDDIR)/mic/libxs.o $(BLDDIR)/mic/libxs_alloc.o $(BLDDIR)/mic/libxs_transpose.o \
