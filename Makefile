...
ifneq (0,$(JIT))
$(info =====================================================================)
$(info YOU ARE USING AN EXPERIMENTAL VERSION OF LIBXS WITH JIT SUPPORT)
...
$(OUTDIR)/intel64/libxsgen.$(LIBEXT): $(OBJFILES_GEN_LIB)
	@mkdir -p $(dir $@)
ifeq (0,$(STATIC))
...
$(BLDDIR)/%.o: $(SRCDIR)/%.c $(INCDIR)/libxs.h $(ROOTDIR)/Makefile $(ROOTDIR)/Makefile.inc
	@mkdir -p $(dir $@)
	$(CC) $(CFLAGS) $(DFLAGS) $(IFLAGS) -c $< -o $@
.PHONY: generator
...
ifeq (noarch,$(GENTARGET))
	...
	@echo >> $@
	@echo >> $@
	$(BINDIR)/generator dense $@ libxs_s$(basename $(notdir $@))_knl $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) knl $(PREFETCH_SCHEME) SP
	$(BINDIR)/generator dense $@ libxs_d$(basename $(notdir $@))_knl $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) knl $(PREFETCH_SCHEME) DP
	$(BINDIR)/generator dense $@ libxs_s$(basename $(notdir $@))_hsw $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) hsw $(PREFETCH_SCHEME) SP
	$(BINDIR)/generator dense $@ libxs_d$(basename $(notdir $@))_hsw $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) hsw $(PREFETCH_SCHEME) DP
	$(BINDIR)/generator dense $@ libxs_s$(basename $(notdir $@))_snb $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) snb $(PREFETCH_SCHEME) SP
	$(BINDIR)/generator dense $@ libxs_d$(basename $(notdir $@))_snb $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) snb $(PREFETCH_SCHEME) DP
	$(BINDIR)/generator dense $@ libxs_s$(basename $(notdir $@))_wsm $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) wsm $(PREFETCH_SCHEME) SP
	$(BINDIR)/generator dense $@ libxs_d$(basename $(notdir $@))_wsm $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) wsm $(PREFETCH_SCHEME) DP
else
	@echo "#define LIBXS_GENTARGET_$(GENTARGET)_sp" >> $@
	@echo "#define LIBXS_GENTARGET_$(GENTARGET)_dp" >> $@
	@echo >> $@
	@echo >> $@
	$(BINDIR)/generator dense $@ libxs_s$(basename $(notdir $@))_$(GENTARGET) $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) $(GENTARGET) $(PREFETCH_SCHEME) SP
	$(BINDIR)/generator dense $@ libxs_d$(basename $(notdir $@))_$(GENTARGET) $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) $(GENTARGET) $(PREFETCH_SCHEME) DP
endif
ifneq (0,$(MIC))
	$(BINDIR)/generator dense $@ libxs_s$(basename $(notdir $@))_knc $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) knc $(PREFETCH_SCHEME) SP
	$(BINDIR)/generator dense $@ libxs_d$(basename $(notdir $@))_knc $(MVALUE2) $(NVALUE2) $(KVALUE) $(MVALUE2) $(KVALUE) $(MVALUE2) $(ALPHA) $(BETA) $(ALIGNED_LOADS) $(ALIGNED_STORES) knc $(PREFETCH_SCHEME) DP
endif
	@TMPFILE=`mktemp`
	@sed -i ${TMPFILE} \
...
$(BLDDIR)/mic/%.o: $(SRCDIR)/%.c $(INCDIR)/libxs.h
	@mkdir -p $(dir $@)
	$(CC) $(CFLAGS) $(DFLAGS) $(IFLAGS) -mmic -c $< -o $@
endif
...
$(OUTDIR)/mic/libxs.$(LIBEXT): $(OBJFILES_MIC)
	@mkdir -p $(dir $@)
ifeq (0,$(STATIC))
	$(LD) -o $@ $^ -shared $(LDFLAGS) $(CLDFLAGS)
else
...
$(OUTDIR)/intel64/libxs.$(LIBEXT): $(OBJFILES_HST) $(OBJFILES_GEN_LIB)
	@mkdir -p $(dir $@)
ifeq (0,$(STATIC))
	$(LD) -o $@ $^ -shared $(LDFLAGS) $(CLDFLAGS)
else
