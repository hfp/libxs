...
LIBXS_INLINE unsigned int isqrt_u32(unsigned int u32)
{
...
LIBXS_INLINE unsigned int isqrt_u64(unsigned long long u64)
{
...
LIBXS_INLINE unsigned int icbrt_u32(unsigned int u32)
{
...
LIBXS_INLINE unsigned int icbrt_u64(unsigned long long u64)
{
...
int main(int argc, char* argv[])
{
  ...
  if (libxs_product_limit(12 * 5 * 7 * 11 * 13 * 17, 231, 1) != (2 * 3 * 7 * 11)) exit(EXIT_FAILURE);
  if (libxs_product_limit(12 * 5 * 7, 36, 1) != (2 * 5 * 7)) exit(EXIT_FAILURE);
  if (libxs_product_limit(12 * 13, 13, 1) != 13) exit(EXIT_FAILURE);
  if (libxs_product_limit(1000, 8, 1) != 40) exit(EXIT_FAILURE);
  if (libxs_product_limit(320, 4, 1) != 8) exit(EXIT_FAILURE);
  if (libxs_product_limit(12, 6, 1) != 12) exit(EXIT_FAILURE);
