...
int main()
{
  ...
  if (1 != libxs_gemm_diffn(&a.descriptor, &b.descriptor, 1, sizeof(libxs_gemm_descriptor))) {
    fprintf(stderr, "using dispatched code path\n");
    return 17;
  }
  else if (1 != libxs_gemm_diffn(&b.descriptor, &a.descriptor, 1, sizeof(libxs_gemm_descriptor))) {
    fprintf(stderr, "using dispatched code path\n");
    return 18;
  }
  else if (0 != libxs_gemm_diffn(&a.descriptor, &a.descriptor, 1, sizeof(libxs_gemm_descriptor))) {
    fprintf(stderr, "using dispatched code path\n");
    return 19;
  }
  else if (0 != libxs_gemm_diffn(&b.descriptor, &b.descriptor, 1, sizeof(libxs_gemm_descriptor))) {
    fprintf(stderr, "using dispatched code path\n");
    return 20;
  }
