...
int main()
{
...
#endif
  {
    ...
    if (EXIT_SUCCESS == result && LIBXS_X86_AVX <= cpuid) {
    ...
    if (EXIT_SUCCESS == result && LIBXS_X86_AVX2 <= cpuid) {
    ...
    if (EXIT_SUCCESS == result && LIBXS_X86_AVX512_MIC/*incl. LIBXS_X86_AVX512_CORE*/ <= cpuid) {
