...
direct convolutions are ran highly efficient. LIBXS current convolution support aims at an easy to use invocation of small (direct) convolutions intended for CNN training and classification applications. Currently, the convolution support in LIBXS is ramping up and increasing functionality quickly to be of general use as described in the [Interface](#Interface-for-convolutions).
