...
**NOTE**: Setting LIBXS_VERBOSE to a negative value will dump each generated JIT kernel to a file with each file being named like the function name shown in [Intel&#160;VTune](#profiling).
