...
There are two cases to consider: (1)&#160;an application which is linking statically against LAPACK/BLAS, and (2)&#160;an application which is dynamically linked against LAPACK/BLAS. The first case requires making `-Wl,--wrap=*gemm_ /path/to/libxs.a` (star to be replaced) part of the link-line and then relinking the application:
...
```
ld [...] -Wl,--wrap=mkl_sgemm_ /path/to/libxs.a
ld [...] -Wl,--wrap=mkl_dgemm_ /path/to/libxs.a
ld [...] -Wl,--wrap=mkl_sgemm_,--wrap=mkl_dgemm_ /path/to/libxs.a
```
