...
if [ $# -ne 6 ]
then
  echo "Usage: $(basename $0) iters numa (1-mcdram/0-DDR) TYPE ('A'-ALL/'F'-FP/'B'-BP/'U'-WU) FORMAT ('A'-ALL/'L'-LIBXS/'T'-Tensorflow/'M'-Mixed) padding; using default values: 1000 1 f32 A L 0"
  ITERS=1 #${CHECK_DNN_ITERS}
  NUMA=1
  BIN=f32
  TYPE="A"
  FORMAT="L"
...
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  108 108 8 3 64  3 3 1 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
...
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  224 224 16  3 64  7 7 3 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
...
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  56  56  8 64  64  3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  56  56  8 64  256 1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  8 128 128 3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  8 128 512 1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  8 256 256 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  8 256 256 3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  8 256 1024  1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  7 7 8 512 512 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  7 7 8 2048  512 1 1 3 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  56  56  16  64  64  3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  56  56  16  64  256 1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  16  128 128 3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  16  128 512 1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  16  256 256 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  16  256 256 3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  16  256 1024  1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  7 7 16  512 512 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  7 7 16  2048  512 1 1 3 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  700 161 16  1 64  5 5 1 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  350 80  16  64  64  3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  350 80  16  64  128 5 5 1 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  175 40  16  128 128 3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  175 40  16  128 256 5 5 1 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  84  20  16  256 256 3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  84  20  16  256 512 5 5 1 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  42  10  16  512 512 3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  112 112 8 64  64  1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  56  56  8 64  256 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  56  56  8 256 64  1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  56  56  8 256 128 1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  8 128 512 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  8 512 128 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  8 512 256 1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  8 256 1024  1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  8 512 1024  1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  8 1024  256 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  8 256 1024  1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  8 1024  512 1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  7 7 8 512 512 3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  7 7 8 512 2048  1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  8 1024  2048  1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  7 7 8 2048  512 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  112 112 16  64  64  1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  56  56  16  64  256 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  56  56  16  256 64  1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  56  56  16  256 128 1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  16  128 512 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  16  512 128 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  16  512 256 1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  16  256 1024  1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  28  28  16  512 1024  1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  16  1024  256 1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  16  256 1024  1 1 0 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
#${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  14  14  16  1024  512 1 1 0 2 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
${NUMACTL}  ./layer_example_${BIN}  ${ITERS}  7 7 16  512 512 3 3 1 1 ${TYPE} ${FORMAT} ${PAD}  #&&&&  \
...
>>>>>>> 5dea02e5bda2974effbf51671e8359305c671237
