...
#define GEMM(REAL) LIBXS_FSYMBOL(LIBXS_TPREFIX(REAL, gemm))
...
int main(int argc, char* argv[])
{
  ...
  /**
   * warmup BLAS, and check that a "bigger" DGEMM (above LIBXS's threshold)
   * does not enter a recursion if LIBXS is LD_PRELOADED or wrapped-in
   */
